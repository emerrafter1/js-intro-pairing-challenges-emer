...
function validMobileNumber(phoneNumber){
  ...
  const validPhoneNumber = /^07\d{9}$/
  const validMobileNumberWithPlusPrefix = /^\+447\d{9}$/
  const validMobileNumberWith00Prefix = /^00447\d{9}$/

  return validPhoneNumber.test(phoneNumber) || validMobileNumberWithPlusPrefix.test(phoneNumber) || validMobileNumberWith00Prefix.test(phoneNumber)
}
